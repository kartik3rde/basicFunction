...
export default class BasicFunction {
  ...
  getMinMaxValue(ar) {
    ...
    if (ar.producttype === "variable") {
      ...
      if (arr.length > 1) {
        ...
        const returnString = "From $" + this.nombarFormat(arr.min()) + " USD";
        return returnString;
      }
    }
  }
  getMinMaxValueWithVariation(ar) {
    if (ar.producttype === "variable") {
      ...
      if (ar.dsaleprice) {
        const returnString =
          "From $" + this.nombarFormat(ar.dsaleprice) + " USD";
        return returnString;
      } else {
        const returnString =
          "From $" + this.nombarFormat(ar.dregularprice) + " USD";
        return returnString;
      }
    }
  }
  ...
  generateOrder(stateObj, paymentResponse = "", referrer_url_id, cart, user) {
